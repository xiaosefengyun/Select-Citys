window.LArea = (function() {
    ...
    MobileArea.prototype = {
        ...
        finish: function(e) {
            ...
            // document.getElementById(_self.trigger.id).innerText(provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):('')));
            var triggerId = _self.trigger.id;
            document.getElementById(triggerId).innerText = provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):(''));
